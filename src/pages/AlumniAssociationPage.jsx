...
const committeeYears = [
  {
    ...
    members: [
      ...
      { sno: 2, name: 'Dr. B. Karuna Devi', designation: 'Assistant Professor', position: 'Coordinator', email: 'karuna8062@grcp.ac.in' },
      ...
      { sno: 7, name: 'Mrs. SLS. Mounica Pratyusha', designation: 'Assistant Professor', position: 'Member', email: 'slsmounicapratyusha8093@grcp.ac.in' },
      { sno: 8, name: 'Ms. Naga Lakshmi (1702-24-881-043)', designation: 'Student', position: 'Member', email: 'bondadanagalakshmi4@gmail.com' },
      { sno: 9, name: 'Ms. P. Prathyusha (1702-24-881-053)', designation: 'Student', position: 'Member', email: 'Puttaprathyusha31@gmail.com' },
    ],
  },
  {
    year: '2025-26',
    ...
    <div className="min-h-screen flex flex-col bg-white overflow-x-clip">
      ...
      <main className="flex-1 section-pad">
        <div className="space-y-14">
          ...
          {/* Executive Committee */}
          <section>
            <SectionHeader label="Leadership" title="Executive Committee" />
            <YearTabs compositions={committeeYears} />
          </section>
