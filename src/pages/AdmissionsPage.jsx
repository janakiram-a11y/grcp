      ...
      <table className="w-full border-collapse min-w-[480px]">
        <thead>
          <tr style={{ backgroundColor: college.greenAccent }}>
            <th
              className="font-display font-semibold text-type-ui text-white text-left px-4 py-3 sticky left-0"
            ...
            {cols.map((cat) => (
              <th
                key={cat}
                className="font-display font-semibold text-type-ui text-white text-center px-4 py-3 whitespace-nowrap"
