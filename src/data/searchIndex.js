...
const searchIndex = [
  ...
  { title: 'NBA',                      desc: 'NBA accreditation national board of accreditation B.Pharmacy', route: '/mandatory-disclosures', category: 'Page' },
  { title: 'Mandatory Disclosures',   desc: 'Mandatory disclosures AICTE PCI NBA NIRF compliance', route: '/mandatory-disclosures',         category: 'Page' },
  { title: 'NIRF',                    desc: 'NIRF national institutional ranking framework innovation sustainability', route: '/mandatory-disclosures', category: 'Page' },
